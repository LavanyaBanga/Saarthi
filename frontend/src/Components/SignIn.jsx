...
export default function AuthPage() {
  ...
  if (window.innerWidth < 768) {
    gsap.set(leftImg.current, { autoAlpha: 1 });
    gsap.set(rightImg.current, { autoAlpha: 0 });
    return;
  }
  ...
  tl.to(leftForm.current, {
    x: -40,
    autoAlpha: 0,
    pointerEvents: "none",
  }, 0)
    .to(rightForm.current, {
      x: 0,
      autoAlpha: 1,
      pointerEvents: "auto",
    }, 0.15)
 ...
 const switchToSignIn = () => {
  ...
  className="
    ...
    md:rounded-3xl
    overflow-hidden
    shadow-[0_30px_100px_-20px_rgba(0,0,0,0.2)]
    bg-[#F8F8F8]
    border
    border-gray-200
  "
...
>
            ...
            <div ref={rightForm} className="relative z-10 w-full flex flex-col justify-center px-5 sm:px-8 md:px-12 py-8 md:py-10 backdrop-blur-sm overflow-y-auto">
              <h2 className="text-3xl md:text-4xl  font-bold text-[#5E4A80] mb-2">Create Account</h2>
